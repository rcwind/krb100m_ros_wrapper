...
launch_cmd="$this_script_dir/expect/$file_prefix.expect $IP_OF_SBC $USERNAME_IN_SBC $LOGIN_PROMPT"
...
tmux send-keys -t :1 "roslaunch krb100m_teleop keyboard_teleop.launch --screen" Enter
